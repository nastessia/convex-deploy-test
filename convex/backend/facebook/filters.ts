...
export const FACEBOOK_FILTER_CONFIG: FilterConfig = {
    // Exact matches
    exact: {
...
export function parseFilters(searchParams: URLSearchParams, config: FilterConfig = FACEBOOK_FILTER_CONFIG): ParsedFilters {

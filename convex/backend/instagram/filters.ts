...
export const INSTAGRAM_FILTER_CONFIG: FilterConfig = {
    // Exact matches
    exact: {
...
export function parseFilters(searchParams: URLSearchParams, config: FilterConfig = INSTAGRAM_FILTER_CONFIG): ParsedFilters {

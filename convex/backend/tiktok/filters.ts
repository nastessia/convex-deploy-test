...
export const TIKTOK_FILTER_CONFIG: FilterConfig = {
    // Exact matches
    exact: {
...
export function parseFilters(searchParams: URLSearchParams, config: FilterConfig = TIKTOK_FILTER_CONFIG): ParsedFilters {
